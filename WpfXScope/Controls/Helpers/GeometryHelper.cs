...
namespace WpfXScope.Controls.Helpers
{
    public static class GeometryHelper
    {
        ...
        public static Geometry GetRoundRectangle(Rect baseRect, Thickness thickness, CornerRadius cornerRadius)
        {
            ...
            // TopLeft Rectangle
            var topLeftRect = new Rect(baseRect.Location.X - tolerance,
                                        baseRect.Location.Y - tolerance,
                                        Math.Max(0.0, cornerRadius.TopLeft - leftHalf),
                                        Math.Max(0.0, cornerRadius.TopLeft - topHalf));
            // TopRight Rectangle
            var topRightRect = new Rect(baseRect.Location.X + baseRect.Width - cornerRadius.TopRight + rightHalf + tolerance,
                                         baseRect.Location.Y - tolerance,
                                         Math.Max(0.0, cornerRadius.TopRight - rightHalf),
                                         Math.Max(0.0, cornerRadius.TopRight - topHalf));
            // BottomRight Rectangle
            var bottomRightRect = new Rect(baseRect.Location.X + baseRect.Width - cornerRadius.BottomRight + rightHalf + tolerance,
            ...
            var bottomLeftRect = new Rect(baseRect.Location.X - tolerance,
